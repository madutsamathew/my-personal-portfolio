            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    ...
                    <p className="text-muted-foreground">
                        With over 2 years of experience in web and mobile app development, 
                    ...
                    <p className="text-muted-foreground">
                        ...
                        forefront of the ever-evolving web and mobile landscape.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                        ...
                        <a href="cv.pdf" className="px-6 py-2 rounded-full border border-primary text-primary transition-colors duration-300 hover:bg-primary/10">
                            Download CV
                        </a>
                    </div>
            </div>
                    ...
                    <div className="gradient-border p-6 card-hover bg-card">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-muted-foreground">
                                    Designing intruitive mobile apps and seamless user
                    ...
                    <div className="gradient-border p-6 card-hover bg-card">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-muted-foreground">
                                    Developing software solutions to complex problems and 
